...
4. Deberias ver una pantalla similar a lo siguiente:
   ...
   Al escribir tus credenciales y oprimir el botón de Login verás algo similar a lo siguiente, quedarás registrado hasta que te desconectes:
   
   ![](img/use2.PNG)
   
   Puedes seleccionar el botón de la esquina superior izquierda para abrir el panel de navegación, verás algo similar a lo siguiente:
   
   ![](img/use3.PNG)
   
   Puedes realizar el proceso de Logout seleccionando el botón.
...
1. Create a new application from the application templates with a *Navigation Drawer Activity*.
    ...
    ![](img/navigation-drawer-activity.png)
