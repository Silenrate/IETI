...
2. Desde tu IDE preferido ejecutar la función main de la clase `SpringBootSecureApiApplication` ubicada en `/com/eci/cosw/springbootsecureapi/`.

## Uso FrontEnd

1. Clonar el repositorio.

2. Dirigirte a la carpeta llamada `FrontComponent`.

3. Compilar la aplicación de React con el comando `npm install`.
